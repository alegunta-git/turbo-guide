...
## meta ai
* meaning dejavu , prepare email for 2 days leave , summarize <link>
* essay about aug 15 in india , write poem butterfly , prepare story abt dog and ant 
* how many km from a2b , suggest outfit for bday party 
...
* Follow-Up: “Summarize the top 3 investment opportunities in bullet points.” Pro Tip: Keep drilling down layers
...
* “ChatGPT, help me set up a savings goal: I want to build an emergency fund of ₹100,000 in 10 months. How much should I put aside each month, and what categories should I cut back on?
...
Teachers can provide ChatGPT with the lesson’s objectives and content, and it can generate lesson outlines, teaching resources, and even suggest activities. 
For example, if a teacher is preparing a lesson on the photosynthesis, 
ChatGPT can generate: 
1. A detailed lesson plan 
2. Discussion questions
3. Recommended videos or articles 
4. Worksheet ideas 
5. A list of key terms for students to focus on
