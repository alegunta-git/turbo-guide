...
**LIG**
- Not Saying Prayers in AM time / 12 pm 
- Minimal Danams , Pujas , Archana 
- Not visiting Hyd and Vjw for 3-4 days with hols w/o office worries 
- Not taking Vacation to visit new places 
- Minimize past regrets / past failures ,Worrying 2 much about Future  
- Dont over think on the negatives 
- We cannot control and influence external factors

**Checklist**
- Monthly task list ( time box task , To-do list)
- Important event/dates list ( Contract renewal , Conference(gcal)
- List of goals / Ideas / Notes (meetings , discussion , brainstorm session)
- List of projects ( In Progress , w/ timelines) 
- List of accounts and passwords ( Portals, app accounts) 
- List of links ( Websites , ref docs) , Key people and contact details
- List of training and learnings , holidays or vacations , motivation quotes
- For tools - know basic path , ace power user tips  , search tool hacks

**Need 1 tool to track** 
- **Events , To dos , Travel plans , HC , Doc visit use gcal** 
- Write next day tasks on prior day  , 
- Identify Top 3-5 tasks for the day ,

**G Drive**
- Trackers , notes , ideas , imp ebooks
- Use **Diary** ( BLSD , expense , reminders) , gkeep(errands) 
- Build and Use Trackers , store them on G Drive for analysis
...
**Implementation**
- No tracker wrt Finance , O&M , Reading 
- Not tracking financial markets , 
- **not aware of ROI , loan calculation , MF top 10**
- Not maintaining Tasks , Home repair Checklist 
- not aware of smart shopping , price comparison , search for discounts

## Home

**Home Improvement (403)** 
- Active Interest in apartment mainteance activities at expense of Fin and OTJ
- Again 2-many papers at BR-2 Closet 
- Not using Dad's PC  , Not using Self Laptop  
- Ebooks spread out in PC/Laptop/Ofc laptop  ( Are you info collector)
- Books download - ofc laptop ( not synced up in my HDD)  
- Not selling Scanner in olx
- Dusting Windows , 

**EPC**
- Home Imp - reduce the time allocated for EPC and PCB stuff 

**Search Files/Information**
- Too much time on Scrub activities : scrub BR 2 files/books/HDD files , since 2020
- Less time on net and productive activities
...
**Pain Points Job  Search**
- Not Updating CV ,  Not reviewing good samples CVs , LI
- Not Having a Career Plan  ( If Plan -> Not Adhering to it)  
- Reaching Office late ( 1115 - 1140 am)  
- Not active in Social Network 
- Peaks and Valleys at job

**JOB** 
- Quarterly OKR’s  
- use w/e properly – have a game plan 

**feedback on cv** 
- Current cv not easy to read and  presentable
- you have Potential , results  delivery not upto the mark
- why new books window shopping 
- did you complete the current set of books at home

**Job Search**
- Skim Linkedin Profiled and CV , 
- Download good cv templates and li profiles
- Keep CV in line with the latest buzz technologies ; LI profile
...
* _Did not maintain revision notes/Cheat Sheet_ ,Not applying concepts
* Not exploring LIG Skills , cooking , ifb dish washing , no wbs for topics to read 
- Reading - on and off , no focus , no notes , **do SMART reading 80 20 like Mom**
- Upsc too much reading, chances of selection minimal , 
- 2 much reading at vville , Read a lot of selfhelp & biz mgmt bks 
  - picked easy parts , illusion of progress
  - fix : read p fin ,teck skills , basics (define basics)
* discontinue tracking reading list , Quit reading More Books 
...
**How to fix**
* DONT BOIL OCEAN , DO READING LIST per quarter 
* Track weekly reading , Take notes and schedule revision session
* Stop goal of reading x books per day , y pages per week - if we dont apply the concepts , whats the point of reading !!!
...
- **instead read book on job/p finance (find ways to optimise reading)**
- **Minimize reading Management / CEO books , focus on SDLC/BSA/PM/IT Svc** 
- **For Tech related items : be more hands on wrt execution of code , practice templates**
- **Fix read w/ goals , try to identify 80% value content 20% of book**
- _use wiki to track reading areas_
...
**How to search for new books to read**
...
**Notetaking**
- Rich multimedia notes (evernote/notion) , links (github wiki)  
