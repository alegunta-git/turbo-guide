...
* Q&A : Stack Overflow  ,StackExchange ( code queries) , Quora , Reddit 
...
* video sharing (YouTube,  MetaCafe) , livecasting (Ustream or Justin.TV),
* News aggregation (Google reader, StumbleUpon, or Feedburner)
* YT Data sci : StatQuest with John Starmer , krish naik , Simplilearn , freeCodeCamp , Edureka! , Corey Schafer , Joma Tech
* YT ChatGPT : OpenAI , sentdex , Two Minute Papers , CodeEmporium , Yann LeCun
* Niche : Kaggle , google digital unlocked , apple itunes ,  The Interaction Design Foundation Community 
...
* [pdf highlight desklamp](https://desklamp.io/)
